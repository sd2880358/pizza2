...
echo --------- reinit db
curl -d 0 http://localhost/cs637/donghao_li/pizza2_server/api/day
echo
...
curl -X PUT -d @order1.json -H Content-Type:application/json  http://localhost/cs637/donghao_li/pizza2_server/api/orders/1
echo
...
curl http://localhost/cs637/donghao_li/pizza2_server/api/orders/1
echo
